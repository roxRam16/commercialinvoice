...
Public Class VRUVA001_SYNA22CustomsDeclarationDoc
    Inherits ValidationRUVA

    Sub New()

        _validationtarget = IValidationRoute.ValidationRoutes.RUVA1
    ...
    Protected Overrides Function LoadInitialStockElement() As ValidatorReport
        ...
        '#72
        If [Set](ANS24, CA_CVE_VINCULACION, breakOnEmpty_:=True, runAt_:=ROOMCUBE) Then Return _report
        ...
        '#143
        [Set](ANS20, CA_ADUANA_DESPACHO_ORIGINAL, False, recurring_:=True)
