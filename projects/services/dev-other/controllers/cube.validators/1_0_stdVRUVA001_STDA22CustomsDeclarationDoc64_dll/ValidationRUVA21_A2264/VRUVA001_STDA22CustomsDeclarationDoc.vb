...
Public Class VRUVA001_STDA22CustomsDeclarationDoc
    Inherits ValidationRUVA

    Sub New()

        _validationtarget = IValidationRoute.ValidationRoutes.RUVA21
    ...
    Protected Overrides Function LoadInitialStockElement() As ValidatorReport
        ...
        '#57
        [Set](ANS20, CA_NUMERO_PEDIMENTO_ORIGINAL_COMPLETO, breakOnEmpty_:=False, runAt_:=ROOMCUBE)
