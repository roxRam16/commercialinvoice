...
Public Class VRUVA009_SYNA22CustomsDeclarationDoc
    Inherits ValidationRUVA

    Sub New()

        _validationtarget = IValidationRoute.ValidationRoutes.RUVA9
    ...
    Protected Overrides Function LoadInitialStockElement() As ValidatorReport
        ...
        '#55
        [Set](ANS20, CA_FECHA_PEDIMENTO_ORIGINAL, breakOnEmpty_:=False, runat_:=ROOMCUBE, dateCurrent_:=Now, recurring_:=True, roomNameExt_:="CASE4")
