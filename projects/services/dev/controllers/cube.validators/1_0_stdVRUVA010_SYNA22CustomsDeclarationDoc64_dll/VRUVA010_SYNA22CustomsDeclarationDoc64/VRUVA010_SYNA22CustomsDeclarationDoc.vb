...
Public Class VRUVA010_SYNA22CustomsDeclarationDoc
    Inherits ValidationRUVA

    Sub New()

        _validationtarget = IValidationRoute.ValidationRoutes.RUVA10
    ...
    Protected Overrides Function LoadInitialStockElement() As ValidatorReport
        ...
        '#55
        [Set](ANS20, CA_FECHA_PEDIMENTO_ORIGINAL, breakOnEmpty_:=False, runat_:=ROOMCUBE, dateCurrent_:=Now, recurring_:=True, roomNameExt_:="_CASE4")
        ...
        ''#59"
        '[Set](ANS20, CA_FECHA_PEDIMENTO_ORIGINAL, breakOnEmpty_:=False, runat_:=LOCALCONDITIONS, dateCurrent_:=Now, roomNameExt_:="CASE4")
        ...
        '#64
        If [Set](ANS24, CamposProveedorOperativo.CA_CVE_VINCULACION, breakOnEmpty_:=True, runAt_:=LOCALCONDITIONS, conditions_:=New List(Of String) From {"=", 0}) Then Return _report
