...
Public Class Domicilio
    ...
    <BsonIgnoreIfNull>
    Public Property iddivisionkb As Integer?
    ...
    <BsonIgnoreIfNull>
    Public Property cveMunicipio As String
    ...
    Public Property domicilioPresentacion As String

    Public Property estado As Int16 = 1

    Public Property archivado As Boolean = False
