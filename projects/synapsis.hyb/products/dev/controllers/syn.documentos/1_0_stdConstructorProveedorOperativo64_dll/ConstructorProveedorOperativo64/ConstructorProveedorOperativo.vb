            ...
            Select Case idSeccion_
                ...
                Case SeccionesProvedorOperativo.SPRO1
                    Return New List(Of Nodo) From {
                                                    ...
                                                    Item(CP_ID_PROVEEDOR, IdObject), 'OBJECTID PROVEEDOR
                                                    Item(CP_CVE_PROVEEDOR, Entero), 'Clave p/usuario, secuencia automática
                                                    Item(CA_RAZON_SOCIAL_PROVEEDOR, Texto),
                                                    Item(CP_TIPO_PROVEEDOR, Booleano, useAsMetadata_:=True), 'NACIONAL / EXTRANJERO
                                                    Item(CP_TIPO_USO, Texto), 'IMPO / EXPO
                                                    Item(CP_TIPO_PERSONA_PROVEEDOR, Booleano, useAsMetadata_:=True), 'MORAL -FISICA
                                                    Item(CA_RFC_PROVEEDOR, Texto),
                                                    Item(CA_CVE_RFC_PROVEEDOR, Texto),
                                                    Item(CA_CURP_PROVEEDOR, Texto),
                                                    Item(CA_CVE_CURP_PROVEEDOR, Texto),
                                                    Item(CP_PROVEEDOR_HABILITADO, Booleano)
                                                }

                'Detalle proveedor
                Case SeccionesProvedorOperativo.SPRO2
                    Return New List(Of Nodo) From {
                                                    Item(CP_ID_PROVEEDOR, IdObject),
                                                    Item(CamposProveedorOperativo.CA_TAX_ID_PROVEEDOR, Texto),
                                                    Item(CamposProveedorOperativo.CA_CVE_TAX_ID_PROVEEDOR, Texto),
                                                    ...
                                                    Item(CamposProveedorOperativo.CA_DOMICILIO_FISCAL, Texto),
                                                    Item(CamposDomicilio.CA_CALLE, Texto, longitud_:=80),
                                                    Item(CamposProveedorOperativo.CP_SEC_DOMICILIO_PROVEEDOR, Texto),
                                                    ...
                                                    Item(CA_ESTADO_DOMICILIO_PROVEEDOR, Booleano),
                                                    Item(CA_DOMICILIO_ARCHIVADO_PROVEEDOR, Texto),
                                                    Item(CA_MOTIVO_ARCHIVADO_DOMICILIO_PROVEEDOR, Texto),
                                                    Item(CA_FECHA_ARCHIVADO_DOMICILIO_PROVEEDOR, Texto),
                                                    Item(CP_FIRMA_ELECTRONICA, Texto),
                ...
                Case SeccionesProvedorOperativo.SPRO3
                    Return New List(Of Nodo) From {
                                                    Item(CP_ID_DOMICILIO_PROVEEDOR, Texto),
                ...
                Case SeccionesProvedorOperativo.SPRO4
                    Return New List(Of Nodo) From {
                                                    ...
                                                    Item(CP_PORCENTAJE_VINCULACION, Real)
                                                }
