            ...
            Select Case idSeccion_
                ...
                Case SeccionesProducto.SPTO1
                    Return New List(Of Nodo) From {
                                                    Item(CamposProducto.CP_NOMBRE_COMERCIAL, Texto, 120, useAsMetadata_:=True),
                ...
                Case SeccionesProducto.SPTO2
                    ...
                    Return New List(Of Nodo) From {
                                                    Item(CamposProducto.CP_FRACCION_ARANCELARIA, Texto, 80, useAsMetadata_:=True),
                                                    Item(CamposProducto.CP_DESCRIPCION_FRACCION_ARANCELARIA, Texto, 80, useAsMetadata_:=True),
                                                    Item(CamposProducto.CP_NICO, Texto, useAsMetadata_:=True),
                                                    Item(CamposProducto.CP_DESCRIPCION_NICO, Texto, 80, useAsMetadata_:=True),
                                                    Item(CamposProducto.CP_FECHA_REGISTRO, Fecha),
                                                    Item(CamposProducto.CP_ESTATUS, Texto, 30, useAsMetadata_:=True),
                                                    Item(CamposProducto.CP_OBSERVACION, Texto, 250),
                                                    Item(CamposTarifaArancelaria.CA_CLAVE_UNIDAD_MEDIDA, Texto, 50),
                                                    Item(CamposTarifaArancelaria.CA_UNIDAD_MEDIDA, Texto, 50),
                                                    Item(CamposTarifaArancelaria.CA_UNIDAD_MEDIDA_CORTO, Texto, 50)
                                                  }
                    '
                ...
                Case SeccionesProducto.SPTO3
                    ...
                    Return New List(Of Nodo) From {
                                                    Item(CamposClientes.CA_RAZON_SOCIAL, Texto, 120, useAsMetadata_:=True),
                                                    Item(CamposProveedorOperativo.CA_RAZON_SOCIAL_PROVEEDOR, Texto, 120, useAsMetadata_:=True),
