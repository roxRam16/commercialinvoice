...
Public Interface IControladorProductos : Inherits IDisposable
#Region "Enum"
...
#Region "Métodos"
    ...
    Function BuscarProductosPorNumeroParte(ByVal listadoNumerosParte_ As List(Of String),
                                           ByVal idCliente_ As String) As TagWatcher
    Function BuscarProductosPorDescripcion(ByVal listadoDescripciones_ As List(Of String), ByVal idCliente_ As String,
                                           Optional ByVal razonSocialProveedor As String = Nothing) As TagWatcher
#End Region
