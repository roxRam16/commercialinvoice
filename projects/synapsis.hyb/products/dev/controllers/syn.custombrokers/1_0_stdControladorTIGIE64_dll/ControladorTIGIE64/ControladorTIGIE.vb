...
#Region "Constructores"
    ...
    Sub New()
        ...
        _enlaceDatos = New EnlaceDatos(27)
...
#Region "Funciones"
    Public Function EnlistarFracciones(ByVal texto_ As String) As TagWatcher _
        ...
        Try
            ...
            Using _enlaceDatos As IEnlaceDatos = New EnlaceDatos(27) With
                ...
                Using _entidadDatos As IEntidadDatos = New ConstructorTIGIE()
                    ...
                    Dim collection_ = _enlaceDatos.GetMongoCollection(Of OperacionGenerica)((New ConstructorTIGIE).GetType.Name)
                    ...
                    Dim results = collection_.Aggregate().
                                             ...
                                             Project(Function(e) New With {
                                                ...
                                                Key .NicoDescripcion = DirectCast(e.Seccion(3).Nodos(0), Campo).Valor}).
                                             ToList()
                    ...
                    results.AsEnumerable.ToList().ForEach(Sub(x)
                                                              ...
                                                              listaFracciones.Add(New FraccionArancelaria With {
                                                                ...
                                                                .NicoDescripcion = x.NicoDescripcion
                                                              })
        ...
        Catch ex As Exception
            ...
            Return New TagWatcher(0, Me, "Ha ocurrido un error al generar la consulta")
...
Public Class FraccionArancelaria
    ...
    <BsonIgnoreIfNull>
    Public Property UnidadMedidaCorto As String

    <BsonIgnoreIfNull>
    Public Property CveUnidadMedida As String

    <BsonIgnoreIfNull>
    Public Property Nico As String

    <BsonIgnoreIfNull>
    Public Property NicoDescripcion As String
