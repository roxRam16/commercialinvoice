  		...
  		if(this.type == 'file') {
            ...
            this.component.addEventListener('drop', (event) => {
                ...
                if (this.validateFilesType()) {
                    ...
                    DisplayAlert('&#xA1;Lo sentimos!', 'Uno o m&aacute;s documentos no est&aacute;n permitidos. Solo se aceptan archivos en formato <b>Imagen</b>, <b>PDF</b> o <b>XML</b>.');
