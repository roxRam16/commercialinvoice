                ...
                <div class="modal-dialog modal-sm modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <p>${message_}</p>
                            <input type="password" class="form-control" placeholder="Escriba aqu&iacute;"/>
                        </div>
...
//function DisplayAlert(title, message, action, confirmText, cancelText) {
//    Swal.fire({
//        title: title,
//        text: message,
//        icon: 'warning',
...
//            if (action === "__DELETE_DOCUMENT") {
//                __doPostBack('btnEjecutarBorrar', ''); 
//            }
//        }
//    });
//}
...
function deleteDocument() {
    alert("Documento eliminado (ejecutado desde JS).");
}
