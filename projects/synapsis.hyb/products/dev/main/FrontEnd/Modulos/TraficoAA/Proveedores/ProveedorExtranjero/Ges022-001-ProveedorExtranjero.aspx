<%@ Page Title="" Language="vb" Async="true" AutoEventWireup="false" MasterPageFile="~/FrontEnd/Modulos/Home.Master" CodeBehind="Ges022-001-ProveedorExtranjero.aspx.vb" Inherits=".Ges022_001_ProveedorExtranjero" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="contentBody" runat="server">
    ...
    <GWC:FormControl runat="server" ID="__SYSTEM_MODULE_FORM" HasAutoSave="false" Label="<span style='color:#321761'>Proveedores/compradores </span><span style='color:#782360;'>&nbsp;extranjeros</span>" OnCheckedChanged="MarcarPagina">
        ...
        <Fieldsets>
            <GWC:FieldsetControl ID="fsDatosGenerales" runat="server" Label="Datos Generales" Priority="true" CssClass="mb-3 p-5">
                <ListControls>
                    ...
                    <asp:Panel runat="server" CssClass="col-xs-12 col-12 col-md-1 col-lg-1 mb-5">
                        ...
                        <asp:Label runat="server" CssClass="cl_clave cl_num_clave col-lg-10 col-md-10 col-12 col-xs-12 d-flex justify-content-center" ID="icClave" Text="1"></asp:Label>
                    ...
                    <asp:Panel runat="server" CssClass="col-xs-12 col-12 col-md-11 col-lg-11 mb-5 media-query-clave">

                        <GWC:FindboxControl runat="server" CssClass="col-xs-8 col-10 col-md-11 col-lg-5 mt-5" ID="fcRazonSocial" KeyField="_id" DisplayField="razonsocial" Label="Razón social" Rules="required|maxlegth[120]" OnClick="fcRazonSocial_Click" OnTextChanged="fcRazonSocial_TextChanged" />

                        <GWC:SwitchControl runat="server" CssClass="col-xs-4 col-2 col-md-1 col-lg-2 mt-5" ID="swcHabilitado" Label="Habilitado" OnText="Si" OffText="No" Checked="False" Visible="False" OnCheckedChanged="swcHabilitado_CheckedChanged" />
                        ...
                        <ListControls>
                            <asp:Panel runat="server" CssClass="m-0 mt-0 p-0" ID="Panel1">
                               ...
                               <GWC:FindboxControl runat="server" CssClass="col-xs-10 col-10 col-md-10 col-lg-11 mt-3 mb-5 pb-5" ID="fcPaises" KeyField="_id" DisplayField="País" Label="Buscar país..." OnTextChanged="fcPaises_TextChanged" OnClick="fcPaises_Click" />
                                ...
                                <GWC:SelectControl runat="server" CssClass="col-xs-12 col-12 col-md-10 col-lg-11 mt-5 mb-5" ID="scDomiciliosRegistrados" LocalSearch="False" Label="Domicilios disponibles" Visible="false" OnClick="scDomiciliosRegistrados_Click" OnTextChanged="scDomiciliosRegistrados_TextChanged"></GWC:SelectControl>
                        ...
                        <ListControls>
                              <asp:Panel runat="server" CssClass="col-xs-12 col-md-12 col-lg-12">
                                ...
                                <asp:Panel runat="server" CssClass="col-xs-12 col-12 col-md-2 col-lg-2 mb-5">
                                    <asp:Label runat="server" CssClass="cl_clave_sec col-lg-10 col-md-10 col-12 col-xs-12 d-flex justify-content-center" ID="Label11" Text="Secuencia"></asp:Label>
                              ...
                              <asp:Panel runat="server" CssClass="col-xs-12 col-12 col-md-10 col-lg-10" ID="Panel5">
                                   ...
                                   <asp:Panel runat="server" CssClass="col-xs-12 col-12 col-md-3 col-lg-4 d-flex justify-content-end" ID="Panel4">
                ...
                <ListControls>
                    <GWC:CatalogControl runat="server" ID="ccConfiguracionAdicional" KeyField="indice" CssClass="w-100" Collapsed="true">
                        <Columns>
                            ...
                            <GWC:SelectControl runat="server" ID="scIncoterm" Label="INCOTERM" HasDetails="true" RequiredSelect="true" KeyField="i_Cve_TerminoFacturacion" DisplayField="t_ValorPresentacion" Dimension="Vt022TerminosFacturacionA14">
                            </GWC:SelectControl>
                        </Columns>
                    </GWC:CatalogControl>
                </ListControls>
