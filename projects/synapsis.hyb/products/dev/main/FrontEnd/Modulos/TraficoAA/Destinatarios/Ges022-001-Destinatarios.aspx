<%@ Page Title="" Language="vb" Async="true" AutoEventWireup="false" MasterPageFile="~/FrontEnd/Modulos/Home.Master" CodeBehind="Ges022-001-Destinatarios.aspx.vb" Inherits=".Ges022_001_Destinatarios" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentFindbar" runat="server">
    ...
    <GWC:FindbarControl Label="Buscar Destinatario" ID="__SYSTEM_CONTEXT_FINDER" runat="server" OnClick="BusquedaGeneral"/>
...
<asp:Content ID="Content3" ContentPlaceHolderID="contentBody" runat="server">
    ...
    <GWC:FormControl runat="server" ID="__SYSTEM_MODULE_FORM" HasAutoSave="false" Label="<span style='color:#321761'>Destinatarios </span><span style='color:#782360;'>&nbsp;</span>" OnCheckedChanged="MarcarPagina">
        ...
        <Fieldsets>
            <GWC:FieldsetControl ID="fsDatosGenerales" runat="server" Label="Datos Generales" Priority="true" CssClass="mb-3 p-5">
                <ListControls>
                    ...
                    <GWC:CardControl runat="server" ID="aviso" CssClass="container wc-card-danger mb-5" Visible="False">
                        <ListControls>
                            <asp:Panel runat="server" CssClass="m-0 mt-0 p-0" ID="Panel2">
                                <asp:Label runat="server" ID="lbTitleAviso" Text="<svg xmlns='http://www.w3.org/2000/svg'  height='24' width='24' viewBox='0 0 512 512'><path d='M464 256A208 208 0 1 0 48 256a208 208 0 1 0 416 0zM0 256a256 256 0 1 1 512 0A256 256 0 1 1 0 256zm177.6 62.1C192.8 334.5 218.8 352 256 352s63.2-17.5 78.4-33.9c9-9.7 24.2-10.4 33.9-1.4s10.4 24.2 1.4 33.9c-22 23.8-60 49.4-113.6 49.4s-91.7-25.5-113.6-49.4c-9-9.7-8.4-24.9 1.4-33.9s24.9-8.4 33.9 1.4zM144.4 208a32 32 0 1 1 64 0 32 32 0 1 1 -64 0zm192-32a32 32 0 1 1 0 64 32 32 0 1 1 0-64z'/></svg> &nbsp; Este &nbsp;<span style='font-weight:bold !important'>destinatario</span>&nbsp; ya ha sido &nbsp;<span style='font-weight:bold !important; color:#432776 !important'> registrado </span>.&nbsp;" Visible="True" CssClass="mb-5 title_Card" Style="font-weight: normal !important; font-size: 18px !important; color: #5b5b5b !important"></asp:Label>
                            </asp:Panel>
                        </ListControls>
                    </GWC:CardControl>


                    <asp:Panel runat="server" CssClass="col-xs-12 col-12 col-md-1 col-lg-1 mb-1">
                    ...
                    <asp:Panel runat="server" CssClass="col-xs-12 col-12 col-md-11 col-lg-11 mb-1 media-query-clave">

                        <GWC:FindboxControl runat="server" CssClass="col-xs-12 col-12 col-md-11 col-lg-5 mt-5" ID="fcRazonSocialDestinatario" KeyField="_id" DisplayField="razonsocial" Label="Razón social" Rules="required|maxlegth[120]" OnClick="fcRazonSocialDestinatario_Click" OnTextChanged="fcRazonSocialDestinatario_TextChanged"/>
                      
                        <GWC:SwitchControl runat="server" CssClass="col-xs-12 col-12 col-md-1 col-lg-1 mt-5" ID="swcbuscarempresa" Label="Extranjero" OnText="Si" OffText="No" Checked="True" OnCheckedChanged="swcbuscarempresa_CheckedChanged"/>

                        <GWC:SwitchControl runat="server" CssClass="col-xs-12 col-12 col-md-1 col-lg-1 mt-5" ID="swcHabilitado" Label="Habilitado" OnText="Si" OffText="No" Checked="False" OnCheckedChanged="swcHabilitado_CheckedChanged"/>
            ...
            <GWC:FieldsetControl runat="server" ID="fsDetalles" Label="Domicilios" Detail="Domicilios" CssClass="mt-5">
                <ListControls>
                         <GWC:CardControl runat="server" ID="ConfigurarDomicilios" CssClass="container p-0 mb-5" Visible="False" Enabled="False">
                                 <ListControls>
                                     <asp:Panel runat="server" CssClass="m-0 mt-0 p-0 mb-5" ID="Panel1">
                                         <asp:Label runat="server" ID="lbTitle" Text="🌐 &nbsp; Seleccionar &nbsp;<span style='font-weight:bold !important'> país</span>&nbsp;" CssClass="mb-3 title_Card" Style="font-weight: normal !important; font-size: 16px !important; color: #321761 !important; opacity:1 !important"></asp:Label>
                                         <GWC:FindboxControl runat="server" CssClass="col-xs-10 col-10 col-md-10 col-lg-11 mt-3 mb-5 pb-5" ID="fcPaises" KeyField="_id" DisplayField="País" Label="Buscar país..." OnTextChanged="fcPaises_TextChanged" OnClick="fcPaises_Click" />
                                         <asp:Label runat="server" ID="lbtitleDomicilios" Text="&nbsp; Seleccione un &nbsp;<span style='font-weight:bold !important'>domicilio</span>" CssClass="w-100 mb-5 title_Card mt-5" Style="font-weight: normal !important; font-size: 18px !important;" Visible="false"></asp:Label>
                                         <GWC:SelectControl runat="server" CssClass="col-xs-12 col-12 col-md-10 col-lg-11 mt-5 mb-5" ID="scDomiciliosRegistrados" LocalSearch="False" Label="Domicilios disponibles" Visible="false" ></GWC:SelectControl>
                                         <GWC:ButtonControl runat="server" CssClass="col-xs-12 col-12 col-md-2 col-lg-1  mt-3 mb-5 d-flex justify-content-end" ID="btnTipoDomicilio" Label="Aplicar" OnClick="btnTipoDomicilio_Click" style="border-radius:10px 10px !important"/>
                                     </asp:Panel>
                                 </ListControls>
                       </GWC:CardControl>

                    <GWC:CardControl runat="server" ID="ConfigurarDomiciliosNacionales" CssClass="container m-0 mb-5" Visible="False">
                         <ListControls>
                             <asp:Panel runat="server" CssClass="m-0 mt-0 p-0 mb-5" ID="Panel4">
                                    <asp:Label runat="server" ID="Label10" Text="📌 &nbsp; Seleccionar &nbsp;<span style='font-weight:bold !important'> domicilio</span>&nbsp;" CssClass="mb-5 title_Card" Style="font-weight: normal !important; font-size: 16px !important; color: #321761 !important; opacity:1 !important"></asp:Label>
                                    <GWC:SelectControl runat="server" CssClass="col-xs-12 col-12 col-md-11 col-lg-11 mt-5 mb-5" ID="ListaDomiciliosNacionales" LocalSearch="False" style="color:#424242 !important" Label="Domicilios disponibles" OnTextChanged="ListaDomiciliosNacionales_TextChanged" OnClick="ListaDomiciliosNacionales_Click" OnSelectedIndexChanged="ListaDomiciliosNacionales_SelectedIndexChanged"></GWC:SelectControl>
                                    <GWC:ButtonControl runat="server" CssClass="col-xs-12 col-12 col-md-1 col-lg-1 mt-0 mb-5 d-flex justify-content-center" ID="btnAplicarDomicilioNacional" Label="Aplicar" OnClick="btnAplicarDomicilioNacional_Click" style="border-radius:10px 10px !important" />
                             </asp:Panel>
                         </ListControls>
                     </GWC:CardControl>

                    <GWC:PillboxControl runat="server" ID="pbDetalleDomicilioDestinatario" KeyField="indice" CssClass="col-xs-12 m-0 p-0" OnCheckedChange="pbDetalleDomicilioDestinatario_CheckedChange" OnClick="pbDetalleDomicilioDestinatario_Click">
                        ...
                        <ListControls>
                            <asp:Panel runat="server" CssClass="col-xs-12 col-md-12 col-lg-12">
                              ...
                              <asp:Panel runat="server" CssClass="col-xs-12 col-12 col-md-2 col-lg-2 mb-5">
                                  <asp:Label runat="server" CssClass="cl_clave_sec col-lg-10 col-md-10 col-12 col-xs-12 d-flex justify-content-center" ID="Label2" Text="Secuencia"></asp:Label>
                                  <asp:Label runat="server" CssClass="cl_clave_sec cl_num_clave_secundario col-lg-10 col-md-10 col-12 col-xs-12 d-flex justify-content-center" ID="lbNumero" Text="1"></asp:Label>
                              </asp:Panel>

                            <asp:Panel runat="server" CssClass="col-xs-12 col-12 col-md-10 col-lg-10" ID="Panel5">

                                  <asp:Panel runat="server" CssClass="col-xs-12 col-12 col-md-7 col-lg-8"> </asp:Panel>

                                 <asp:Panel runat="server" CssClass="col-xs-12 col-12 col-md-3 col-lg-4 d-flex justify-content-end" ID="Panel3">
                                     <GWC:InputControl runat="server" Type="Hide" ID="icCveTaxid" Label="CVETAXID" />
                                     <GWC:InputControl runat="server" CssClass="col-xs-12 col-12 col-md-12 col-lg-11" Type="Text" ID="icTaxid" Label="Taxid" />
                                 </asp:Panel>
                            </asp:Panel>
                            ...
                            <asp:Panel runat="server" CssClass="mt-5 col-xs-12 col-12 col-md-12 col-lg-12" ID="sectionDomicilio">
                                ...
                                <GWC:InputControl runat="server" CssClass="col-xs-12 col-md-6 col-lg-6 mb-3 mt-5" Type="Text" ID="icCalle" Label="Calle" Rules="required" />
                                <GWC:InputControl runat="server" CssClass="col-xs-12 col-md-3 mb-3 mt-5" Type="Text" ID="icNumeroExterior" Label="Número exterior" Rules="required" />
                                <GWC:InputControl runat="server" CssClass="col-xs-12 col-md-3 mb-3 mt-5" Type="Text" ID="icNumeroInterior" Label="Número interior" />
                                <GWC:InputControl runat="server" CssClass="col-xs-12 col-md-3 mb-3" Type="Text" ID="icCodigoPostal" Label="Código postal" />
                                ...
                                <GWC:InputControl runat="server" CssClass="col-xs-12 col-md-3 mt-3" Type="Text" ID="icMunicipio" Label="Municipio" />
                                <GWC:InputControl runat="server" CssClass="col-xs-12 col-md-3 mt-3" Type="Text" ID="icEntidadFederativa" Label="Entidad federativa" />
