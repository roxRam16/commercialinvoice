	...
	constructor() {
  	...
  	connectedCallback() {
            ...
            this._component.addEventListener('input', function () {
                ...
                const keywords_ = ['ABS','AHORA', 'ASIGNAR' ,'BUSCAR','BUSCARV', 'COINCIDIR', 'CONCATENAR', 'DENTRO', 'DICCIONARIO',
                    'ENLISTAR', 'ESBLANCO', 'ESPACIOS', 'EXTRAE' ,'HALLAR', 'HOY', 'LARGO', 'MEZCLAR', 'NO', 'O', 'OBTENERVALOR', 'RANGO', 'RED', 'REDONDEAR',
