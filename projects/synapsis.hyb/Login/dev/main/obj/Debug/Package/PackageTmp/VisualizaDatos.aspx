<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="VisualizaDatos.aspx.vb" Inherits="WebVisualizador" %>
...
<body>
    <form id="fWebRegister" runat="server">
        <div>
            ...
            <asp:Button ID="btChecaConstructor" Text="Checa Paso por Constructor" runat="server" OnClick="AsignarPrivilegios_Click" />
