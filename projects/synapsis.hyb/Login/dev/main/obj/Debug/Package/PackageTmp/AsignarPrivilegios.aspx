        ...
        <div>
           ...
           <div class="group-container">
             <div class="col-md-4 checkbox-group">
                  ...
                  <asp:CheckBox ID="ckbCDMX" Text="CDMX" runat="server"></asp:CheckBox><br />
                  ...
                  <asp:CheckBox ID="ckbTuxpan" Text="Tuxpan" runat="server"></asp:CheckBox><br />
                  <asp:CheckBox ID="ckbNuevoLaredo" Text="Nuevo Laredo" runat="server"></asp:CheckBox><br />
                  <asp:CheckBox ID="ckbNogales" Text="Nogales" runat="server"></asp:CheckBox><br />
            </div>
           <div class="group-container">
             <div class="col-md-4 checkbox-group">
