    ...
    Public Sub ProcessRequest(context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        If context.Request.Path = "/FileUploadHandler.upload" Then
            ...
            If context.Request.Files.Count > 0 Then
                ...
                For i As Integer = 0 To files.Count - 1
                    ...
                    Dim propiedadesDocumento As PropiedadesDocumento

                    If data IsNot Nothing Then
                        propiedadesDocumento = New JavaScriptSerializer().Deserialize(Of PropiedadesDocumento)(New JavaScriptSerializer().Serialize(data.Item("data")))
                    Else
                        propiedadesDocumento = New PropiedadesDocumento()
                    End If
        ...
        ElseIf context.Request.Path = "/FileUploadHandler.download" Then
            ...
            If document_ Is Nothing Then
                ...
                Dim response_ As New TagWatcher

                With response_.Status

                    Code = 400

                    Message = "No se ha cargado ningun documento"

                End With

                response_.SetOKBut(Me, "No se ha cargado ningun documento")
