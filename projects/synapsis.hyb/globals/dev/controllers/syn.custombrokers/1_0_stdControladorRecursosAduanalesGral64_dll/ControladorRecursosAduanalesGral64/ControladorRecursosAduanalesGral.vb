...
#Region "Propiedades"
    ...
    <BsonIgnoreIfNull>
    Property tiposembalajes As List(Of TiposEmbalajes)
...
Public Class TipoCuentaAduanera
    ...
    Property estado As Int16 = 1
    Property archivado As Boolean = False
    Property cvetipocuenta As String
    Property descripcioncorta As String
...
Public Class ClaveGarantia
    ...
    Property estado As Int16 = 1
    Property archivado As Boolean = False
    Property cvegarantia As String
    Property descripcioncorta As String
...
Public Class InstitucionEmisora
    ...
    Property estado As Int16 = 1
    Property archivado As Boolean = False
    Property cveinstitucionemisora As String
    <BsonIgnoreIfNull>
    Property tipoemisora As List(Of tipoemisora)

End Class

Public Class tipoemisora

    <BsonIgnoreIfNull>
    Property idtipoemisora As Int32
    <BsonIgnoreIfNull>
    Property tipoemisora As String
...
Public Class TiposEmbalajes

    Property _idtipoembalaje As Int32
    Property descripcion As String
    Property estado As Int16 = 1
    Property archivado As Boolean = False
