...
#End Region
        ...
        Enum SeccionesPedimento
            ...
            <EnumMember> <Description("Tasas, contribuciones nivel pedimento")> ANS50 = 50
            <EnumMember> <Description("Tasas, contribuciones nivel partida")> ANS51 = 51
        ...
        Public Enum SeccionesAcuseValor
            ...
            <EnumMember> <Description("Datos de Consulta")> SAcuseValor6 = 6

            '#############################  SECCIONES ÚNICAS  DE MÓDULO DE ACUSE DE VALOR ##################################

        End Enum

        Public Enum SeccionesEmpleados

            <EnumMember> <Description("Sin definir")> SEmpleado0 = 0
            <EnumMember> <Description("Generales")> SEmpleado1 = 1
        ...
        Public Enum SeccionesPartesII
            ...
            <EnumMember> <Description("ContenedoresPedimentos")> SPII4 = 4
        ...
        Public Enum SeccionesControlViajes
            ...
            <EnumMember> <Description("Guias")> SCVI3 = 3
        ...
        Public Enum SeccionesDODA

            <EnumMember> <Description("Sin definir")> SDODA0 = 0

            '#############################  SECCIONES ÚNICAS EXPEDIENTE ELECTRÓNICO ##################################
            <EnumMember> <Description("Generales")> SDODA1 = 1
            <EnumMember> <Description("Pedimentos")> SDODA2 = 2
            <EnumMember> <Description("Contenedores")> SDODA3 = 3
            <EnumMember> <Description("Candados")> SDODA4 = 4
            <EnumMember> <Description("CartasPorte")> SDODA5 = 5
            '#############################  SECCIONES ÚNICAS EXPEDIENTE ELECTRÓNICO ##################################

        End Enum

        Public Enum SeccionesUnidadesNegocio

            <EnumMember> <Description("Sin definir")> SUN0 = 0

            '#############################  SECCIONES ÚNICAS EXPEDIENTE ELECTRÓNICO ##################################
            <EnumMember> <Description("Generales")> SUN1 = 1
            <EnumMember> <Description("Aduanas por defecto")> SUN2 = 2
            <EnumMember> <Description("Pago electrónico")> SUN3 = 3
            '#############################  SECCIONES ÚNICAS EXPEDIENTE ELECTRÓNICO ##################################
        End Enum
        ...
        Public Enum CamposPedimento
            ...
            <EnumMember> <Description("NUMERO TOTAL DE PARTIDAS")> CA_NUMERO_TOTAL_PARTIDAS = 21
            ...
            <EnumMember> <Description("OBJECTID DE LA PARTIDA DEL PEDIMENTO")> CP_ID_PARTIDA = 1172
            <EnumMember> <Description("CONSOLIDADOS - CANTIDAD DE VEHÍCULOS DESPACHADOS")> CP_NUMERO_VEHICULOS_DESPACHADOS = 1173
            <EnumMember> <Description("TIPO DE GUIA PARA LLENADO DE SWICHT")> CP_TIPO_GUIA = 1174
        ...
        Public Enum CamposReferencia
            ...
            <EnumMember> <Description("CLAVE DE LA UNIDAD DE NEGOCIO DEL CLIENTE")> CP_CVE_UNIDAD_NEGOCIO = 2531
            <EnumMember> <Description("OBJECT ID DE LA UNIDAD DE NEGOCIO DEL CLIENTE")> CP_ID_UNIDAD_NEGOCIO = 2532
            <EnumMember> <Description("OBJECT ID PEDIMENTO")> CP_ID_PEDIMENTO = 2533
        ...
        Public Enum CamposFacturaComercial
            ...
            <EnumMember> <Description("Valor agregado item")> CP_VALOR_AGREGADO_ITEM = 3075
            <EnumMember> <Description("Moneda valor agregado item")> CP_MONEDA_VALOR_AGREGADO_ITEM = 3076
            <EnumMember> <Description("Número factura subdivisión")> CP_NUMERO_FACTURA_SUBDIVISION = 3077
            <EnumMember> <Description("Id factura original")> CP_ID_FACTURA_ORIGINAL = 3078
        ...
        Public Enum CamposAcuseValor
            ...
            <EnumMember> <Description("Descripción COVE")> CA_DESCRIPCION_PARTIDA_ACUSEVALOR = 4009
            <EnumMember> <Description("Unidad de medida COVE")> CA_UNIDAD_MEDIDA_FACTURA_PARTIDA_ACUSEVALOR = 4010
            <EnumMember> <Description("Valor mercancía dólares")> CA_VALOR_MERCANCIA_PARTIDA_DOLARES_ACUSEVALOR = 4011
            ...
            <EnumMember> <Description("Sello del Importador")> CA_SELLO_ACUSEVALOR = 4012
            <EnumMember> <Description("Patente del Agente Aduanal")> CA_PATENTE_ACUSEVALOR = 4013
            <EnumMember> <Description("RFC'S de Consulta")> CA_RFC_CONSULTA_ACUSEVALOR = 4014
            <EnumMember> <Description("Razón Social de Consulta")> CP_RAZON_SOCIAL_CONSULTA_ACUSEVALOR = 4015
            <EnumMember> <Description("E-mail de Consulta")> CP_EMAIL_CONSULTA_ACUSEVALOR = 4016
            <EnumMember> <Description("Tipo de Figura del usuario COVE")> CA_TIPO_FIGURA = 4017
            <EnumMember> <Description("ID del Acuse de Valor")> CP_ID_ACUSEVALOR = 4018
            <EnumMember> <Description("ID del Cliente que selló")> CP_ID_CLIENTE_SELLO = 4019
            <EnumMember> <Description("ID del Agente Aduanal que selló ")> CP_ID_AGENTE_SELLO = 4020
            <EnumMember> <Description("Tipo de Persona del Sello Utilizado ")> CP_TIPO_SELLO = 4021
            'DATOS DEL EMISOR
            <EnumMember> <Description("ID del Emisor(Proveedor/Comprador)")> CP_ID_EMISOR = 4022
            <EnumMember> <Description("Tax Id del Emisor")> CA_TAX_ID_EMISOR = 4023
            <EnumMember> <Description("RFC del Emisor")> CA_RFC_EMISOR = 4024
            <EnumMember> <Description("Razón Social del Emisor")> CA_RAZON_SOCIAL_EMISOR = 4025
            <EnumMember> <Description("Curp del Emisor")> CA_CURP_EMISOR = 4026
            <EnumMember> <Description("Tipo de Identificador del Emisor")> CA_TIPO_IDENTIFICADOR_EMISOR = 4027
            'DATOS DEL DESTINATARIO
            <EnumMember> <Description("ID del Destinatario(Proveedor/Comprador)")> CP_ID_DESTINATARIO_ACUSE = 4028
            <EnumMember> <Description("Tax Id del Destinatario")> CA_TAX_ID_DESTINATARIO_ACUSE = 4029
            <EnumMember> <Description("RFC del Destinatario")> CA_RFC_DESTINATARIO_ACUSE = 4030
            <EnumMember> <Description("CURP del Destinatario")> CA_CURP_DESTINATARIO_ACUSE = 4031
            <EnumMember> <Description("Razón Social del Destinatario")> CA_RAZON_SOCIAL_DESTINATARIO_ACUSE = 4032
            <EnumMember> <Description("Tipo de Identificador Usado por el Destinatario")> CA_TIPO_IDENTIFICADOR_DESTINATARIO_ACUSE = 4033
        ...
        Public Enum CamposProducto
            ...
            <EnumMember> <Description("ObjectID del Producto")> CP_ID_PRODUCTO = 9023
            <EnumMember> <Description("ObjectID del Detalle del Producto")> CP_ID_DETALLE_PRODUCTO = 9024
            <EnumMember> <Description("TimeStamp para el sello del cambio de producto")> CP_TIMESTAMP = 9025
        ...
        Public Enum CamposGuias
            ...
            <EnumMember> <Description("Es contenerizada")> CP_CONTENERIZADA = 17007
            ...
            <EnumMember> <Description("Es subdivision")> CP_SUBDIVIDIR = 17033
            <EnumMember> <Description("El consignatario es cliente")> CP_TIPO_CONSIGNATARIO = 17034
            <EnumMember> <Description("Id info contenedor")> CP_ID_INFO_CONTENEDOR = 17035
            <EnumMember> <Description("Id info carga suelta")> CP_ID_INFO_CARGA_SUELTA = 17036
            <EnumMember> <Description("Documento tarja revalidado")> CP_DOCUMENTO_TARJA = 17037
            <EnumMember> <Description("Inhabilitar para pedimento")> CP_INHABILITADO = 17038
            <EnumMember> <Description("Tipo de carga")> CP_TIPO_CARGA_GUIA = 17039
            <EnumMember> <Description("Dividir contenedor")> CP_DIVIDIR_CONTENEDOR = 17040
        ...
        Public Enum CamposPartesII
            ...
            <EnumMember> <Description("Vigencia")> CP_VIGENCIA = 18003
            <EnumMember> <Description("Bultos")> CP_BULTOS = 18004
            <EnumMember> <Description("Fecha despacho")> CP_FECHA_DESPACHO = 18005
            <EnumMember> <Description("Impreso")> CP_IMPRESO = 18006
            <EnumMember> <Description("Contenedor")> CP_CONTENEDOR = 18007
            <EnumMember> <Description("Color candado")> CP_COLOR_CANDADO = 18008
            <EnumMember> <Description("ContenedorPedimento")> CP_CONTENEDOR_PEDIMENTO = 18009
        ...
        Public Enum CamposExpedienteElectronico
            ...
            'Datos generales de cliente y su lsita de expedientes
            <EnumMember> <Description("Customer id")> CP_ID_CLIENTE = 19001
            <EnumMember> <Description("Customer taxid")> CP_TAXID_CLIENTE = 19002
            <EnumMember> <Description("Customer name")> CP_RAZON_SOCIAL_CLIENTE = 19003

            <EnumMember> <Description("Total packages opened")> CP_TOTAL_EXPEDIENTES_ABIERTOS = 19004
            <EnumMember> <Description("Total packages closed")> CP_TOTAL_EXPEDIENTES_CERRADOS = 19005

            <EnumMember> <Description("Last updated packages client")> CP_ULTIMA_ACTUALIZACION_EXPEDIENTES_CLIENTE = 19006

            'Datos de cada expediente
            <EnumMember> <Description("Owner user email")> CP_OWNER_USER_EMAIL_EXPEDIENTE = 19007
            <EnumMember> <Description("Owner name")> CP_OWNER_NAME_EXPEDIENTE = 19008

            <EnumMember> <Description("Reference")> CP_REFERENCIA_EXPEDIENTE = 19009
            <EnumMember> <Description("Status")> CP_ESTATUS_EXPEDIENTE = 19010

            <EnumMember> <Description("Creation date")> CP_CREACION_EXPEDIENTE = 19011
            <EnumMember> <Description("Last update date")> CP_ULTIMA_ACTUALIZACION_EXPEDIENTE = 19012


        End Enum

        Public Enum CamposDODA

            'Región del 20000 - 20999
            <EnumMember> <Description("Sin definir")> SIN_DEFINIR = 20000

            'Datos generales del DODA
            <EnumMember> <Description("Número de Ticket")> CA_NUMERO_TICKET = 20001
            <EnumMember> <Description("Numero de Integración")> CA_NUMERO_INTEGRACION = 20002
            <EnumMember> <Description("Despacho Aduanero")> CA_DESPACHO_ADUANERO = 20003
            <EnumMember> <Description("Aduana")> CA_ADUANA = 20004
            <EnumMember> <Description("Seccion")> CA_SECCION = 20005
            <EnumMember> <Description("Customer Id")> CP_ID_CLIENTE = 20006
            <EnumMember> <Description("Customer name")> CP_RAZON_SOCIAL_CLIENTE = 20007
            <EnumMember> <Description("RFC del Cliente")> CA_RFC_CLIENTE = 20008
            <EnumMember> <Description("RFC del Agente")> CA_RFC_AGENTE = 20009
            <EnumMember> <Description("Número de Gafete Único")> CA_NUMERO_GAFETE_UNICO = 20010
            <EnumMember> <Description("CAAT")> CA_CAAT = 20011
            <EnumMember> <Description("ID Tranporte")> CA_ID_TRANSPORTE = 20012
            <EnumMember> <Description("Clave del Transportista")> CP_CLAVE_TRANSPORTISTA = 20013
            <EnumMember> <Description("Nombre del Transportista")> CP_NOMBRE_TRANSPORTISTA = 20014
            <EnumMember> <Description("FastID")> CA_FAST_ID = 20015
            <EnumMember> <Description("Tipo de Operación")> CA_TIPO_OPERACION = 20016
            <EnumMember> <Description("Carta Porte")> CA_CARTA_PORTE = 20017
            <EnumMember> <Description("Fecha de Desaduanamiento")> CA_FECHA_DESPACHO = 20018
            <EnumMember> <Description("Owner user email")> CP_OWNER_USER_EMAIL_DODA = 20019
            <EnumMember> <Description("Owner name")> CP_OWNER_NAME_DODA = 20020
            <EnumMember> <Description("Environment ID")> CP_ENVIRONMENT_ID = 20021
            <EnumMember> <Description("Cadena Original")> CP_CADENA_ORIGINAL = 20022
            <EnumMember> <Description("Hubo Errores")> CP_ERRORES = 20023
            <EnumMember> <Description("Descripción de errores")> CP_DESCRIPCION_ERRORES = 20024

            'Documentos
            <EnumMember> <Description("Patente")> CP_ID_DOCUMENTO = 20025
            <EnumMember> <Description("Patente")> CA_PATENTE = 20026
            <EnumMember> <Description("Numero de Referencia")> CA_NUMERO_REFERENCIA = 20027
            <EnumMember> <Description("Numero de Pedimento/Remesa/PartesII")> CA_NUMERO_DOCUMENTO = 20028
            <EnumMember> <Description("Numero de Remesa")> CA_NUMERO_REMESA = 20029
            <EnumMember> <Description("Clave del Documento")> CA_CLAVE_DOCUMENTO = 20030
            <EnumMember> <Description("dtaNiu")> CA_DTA_NIU = 20031
            <EnumMember> <Description("importeDifDolares")> CA_IMPORTE_DIFF_DOLARES = 20032
            <EnumMember> <Description("importeEfectivoDolares")> CA_IMPORTE_EFECTIVO_DOLARES = 20033
            <EnumMember> <Description("Campo12Apendice17")> CA_CAMPO_12_APENDICE_17 = 20034
            <EnumMember> <Description("COVE")> CA_COVE = 20035
            <EnumMember> <Description("UMC")> CA_UMC = 20036
            <EnumMember> <Description("XML DODA ENVIO")> CP_OBJECT_ID_XML_ENVIO = 20037
            <EnumMember> <Description("XML DODA RESPUESTA")> CP_OBJECT_ID_XML_RESPUESTA = 20038
            <EnumMember> <Description("PDF DODA")> CP_OBJECT_ID_PDF = 20039
            <EnumMember> <Description("XML DODA ENVIO GOOGLE")> CP_GOOGLE_XML_ENVIO = 20040
            <EnumMember> <Description("XML DODA RESPUESTA GOOGLE")> CP_GOOGLE_XML_RESPUESTA = 20041
            <EnumMember> <Description("PDF DODA GOOGLE")> CP_GOOGLE_PDF = 20042


            'Contenedores y Candados
            <EnumMember> <Description("Valor Contenedor")> CA_VALOR_CONTENEDOR = 20043
            <EnumMember> <Description("Tipo de Contnedor")> CP_TIPO_CONTENEDOR = 20044
            <EnumMember> <Description("Número de Candado")> CA_NUMERO_CANDADO = 20045
            <EnumMember> <Description("Candado 1RA")> CP_CANDADO1RA = 20046
            <EnumMember> <Description("Candado 2DA")> CP_CANDADO2DA = 20047


        End Enum

        Public Enum CamposUnidadesNegocio
            'Región del 21000 - 21999
            <EnumMember> <Description("Sin definir")> SIN_DEFINIR = 21000 '
            <EnumMember> <Description("Id del cliente")> ID_CLIENTE = 21001
            <EnumMember> <Description("Nombre de la unidad de negocio")> NOMBRE_LARGO = 21002
            <EnumMember> <Description("Nombre corto")> NOMBRE_CORTO = 21003
            <EnumMember> <Description("RFC del cliente")> RFC = 21004
            <EnumMember> <Description("Sw si usa PECE")> SW_USA_PECE = 21005
            <EnumMember> <Description("Domicilio")> DOMICILIO = 21006
            <EnumMember> <Description("Aduana / Modalidad")> ADUANA_MODALIDAD = 21007
            <EnumMember> <Description("Patente")> PATENTE = 21008
        End Enum
