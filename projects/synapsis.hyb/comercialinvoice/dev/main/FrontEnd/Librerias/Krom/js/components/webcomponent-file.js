export class WCFile extends HTMLInputElement {
  		...
  		if(this.type == 'file') {
            ...
            this.component.addEventListener('drop', (event) => {
                ...
                if (this.validateFilesType()) {
                    ...
                    DisplayAlert('&#xA1;Lo sentimos!', 'Uno o m&aacute;s documentos no est&aacute;n permitidos. Solo se aceptan archivos en formato <b>Imagen</b>, <b>PDF</b>, <b>XML</b>, <b>Cer</b> y <b>Key</b>');
    ...
    validateFilesType() {
        ...
        for (let i = 0; i < this.files.length; i++) {
            ...
            const typeimage_ = this.getAttribute('accept');

            const types = typeimage_.split(',');

            

            if (!types.includes(this.files[i].type) && !this.files[i].name.endsWith(".key") ) {
        ...
        try {
            ...
            $.ajax({
                ...
                error: (a) => {
                    ...
                    DisplayAlert('&#xA1;Lo sentimos!', 'No existe un archivo a descargar');
                    ...
                    $.ajax({
                        ...
                        success: (res) => {
                            ...
                            if (res.code == 200) {
                                ...
                                this.component.setAttribute('style', '--percent:0%;');
    ...
    isDisabled() {
        return this.fileInput.hasAttribute('data-disabled');
    }
