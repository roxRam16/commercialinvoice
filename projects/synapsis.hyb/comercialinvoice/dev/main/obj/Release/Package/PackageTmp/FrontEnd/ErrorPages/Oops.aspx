<%@ Page Title="" Language="vb" AutoEventWireup="false" CodeBehind="404.aspx.vb" Inherits=".Oops" %>
...
<body>
    ...
    <section class="containerError">
        ...
        <div class="zoneError">
            <image class="imgPrincipal" src="/FrontEnd/Recursos/Imgs/500.png" />
            <section class="error-box">
                <div class="error-code"></div>

                <div class="error-title">
                    Vaya… no se pudo procesar la solicitud
                </div>

                <div class="error-description">
                    La página no pudo cargarse ahora
                </div>
