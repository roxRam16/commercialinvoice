...
Public Class NuevaPaginaMaestra
...
#Region "Metodos"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Else
            ...
            Dim endpoint_ = _Statement.GetEndPointPods(17)

            Dim paginaLogin_ = "http://" &
                              endpoint_(0).ip &
                              ":" &
                              endpoint_(0).protocols(0).port &
                              "/Login.aspx"
    ...
    Private Sub ObtenerNombreUsuario()
        ...
        _nombreUsuario = userclaim_.Identity.Name ' If(usuario_.Count > 0, usuario_.Item("nombre_usuario") & " " & usuario_.Item("apellidoPaterno_usuario"), "")
    ...
    Public Sub IniciarSession(ByVal usuario_ As String,
        ...
        With datosUsuario_
            ...
            Dim phone_ = userclaim_.Claims.Where(Function(e) e.Type.Contains("homephone")).ToList

            If phone_.Count > 0 Then

                .Add("Telefono", phone_.Item(0).Value)
        ...
        Dim endpoints_ As New Dictionary(Of String, String)

        Dim endpointPods_ As List(Of Sax.endpointpod) = _Statement.GetEndPointPods(17)

        For Each endpointidPod_ In endpointPods_

            endpoints_.Add(endpointidPod_.info.ToUpper, endpointidPod_.ip & ":" & endpointidPod_.protocols(0).port)
