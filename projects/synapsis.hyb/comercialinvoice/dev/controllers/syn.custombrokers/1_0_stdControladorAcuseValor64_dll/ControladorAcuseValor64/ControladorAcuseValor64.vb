...
#Region "Propiedades"
    ...
    Public Property EnvironmentOnline As Int32 _
        Implements IControladorAcuseValor.EnvironmentOnline
        Get
...
#Region "Métodos"
    ...
    Public Function ConsultaAcusesValor(idCoves_ As List(Of ObjectId),
        ...
        Using enlaceDatos_ As IEnlaceDatos = New EnlaceDatos(21) With
            ...
            If campos_ Is Nothing Then
                ...
                Dim operationsDB_ As IMongoCollection(Of OperacionGenerica) =
                    enlaceDatos_.GetMongoCollection(Of OperacionGenerica)(GetType(ConstructorAcuseValor).Name)
    ...
    Public Function ConsultaAcuseValor(idAcuseValor_ As ObjectId,
        ...
        Using enlaceDatos_ As IEnlaceDatos = New EnlaceDatos(21)
            ...
            If campos_ Is Nothing Then
                ...
                Dim operationsDB_ As IMongoCollection(Of OperacionGenerica) = enlaceDatos_.GetMongoCollection(Of OperacionGenerica)(GetType(ConstructorAcuseValor).Name)
    ...
    Public Function GenerarAcuseValor(constructorAcuseValor_ As ConstructorAcuseValor,
        ...
        If acuseValor_.Contains("COVE") Then
            ...
            {.EspacioTrabajo = System.Web.HttpContext.Current.Session("EspacioTrabajoExtranet")}
                ...
                Dim operationsDB_ As IMongoCollection(Of OperacionGenerica) = enlaceDatos_.
    ...
    Public Function GenerarAcuseValor(constructorAcuseValor_ As ConstructorAcuseValor,
        ...
        If acuseValor_.Contains("COVE") Then
            ...
            Dim facturasDisponible_ As TagWatcher = controladorFacturaComercial_.ListaFacturas(idFactura_)

            _acusesValorGenerados = New List(Of ConstructorAcuseValor) From {constructorAcuseValor_}

            If facturasDisponible_.ObjectReturned IsNot Nothing Then
    ...
    Function ActualizarIDS(idCOVE As ObjectId) As TagWatcher Implements IControladorAcuseValor.ActualizarIDS
        ...
        Using iEnlaceDatos_ As IEnlaceDatos = New EnlaceDatos(21)
            ...
            iEnlaceDatos_.EnvironmentOnline = _environmentOnline
