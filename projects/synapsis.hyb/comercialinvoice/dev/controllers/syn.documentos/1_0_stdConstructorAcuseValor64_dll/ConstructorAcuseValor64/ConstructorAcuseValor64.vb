            ...
            Select Case idSeccion_
                ...
                Case SeccionesAcuseValor.SAcuseValor1
                    Return New List(Of Nodo) From {
                                             ...
                                             Item(CamposAcuseValor.CA_TIPO_FIGURA, Entero),
                ...
                ' Datos del proveedor/Comprador/Emisor
                Case SeccionesAcuseValor.SAcuseValor2
                    Return New List(Of Nodo) From {
                                             Item(CamposAcuseValor.CP_ID_EMISOR, IdObject),
                                             Item(CamposAcuseValor.CA_TIPO_IDENTIFICADOR_EMISOR, Texto, longitud_:=15),
                                             Item(CamposAcuseValor.CA_TAX_ID_EMISOR, Texto, longitud_:=15),
                                             Item(CamposAcuseValor.CA_RFC_EMISOR, Texto, longitud_:=13),
                                             Item(CamposAcuseValor.CA_RAZON_SOCIAL_EMISOR, Texto, longitud_:=120),
                                             Item(CamposAcuseValor.CA_CURP_EMISOR, Texto, longitud_:=120),
                ...
                Case SeccionesAcuseValor.SAcuseValor3
                    Return New List(Of Nodo) From {
                                             Item(CamposAcuseValor.CP_ID_DESTINATARIO_ACUSE, IdObject),
                                             Item(CamposAcuseValor.CA_TIPO_IDENTIFICADOR_DESTINATARIO_ACUSE, Texto, longitud_:=15),
                                             Item(CamposAcuseValor.CA_TAX_ID_DESTINATARIO_ACUSE, Texto, longitud_:=11),
                                             Item(CamposAcuseValor.CA_RFC_DESTINATARIO_ACUSE, Texto, longitud_:=13),
                                             Item(CamposAcuseValor.CA_CURP_DESTINATARIO_ACUSE, Texto, longitud_:=120),
                                             Item(CamposAcuseValor.CA_RAZON_SOCIAL_DESTINATARIO_ACUSE, Texto, longitud_:=120),
                                             Item(CamposDomicilio.CP_ID_DOMICILIO, Texto, longitud_:=450),
                                             Item(CamposDomicilio.CA_DOMICILIO_FISCAL, Texto, longitud_:=450),
                                             Item(CamposDomicilio.CA_CALLE, Texto, longitud_:=80),
                                             Item(CamposDomicilio.CA_NUMERO_EXTERIOR, Texto, longitud_:=10),
                                             Item(CamposDomicilio.CA_NUMERO_INTERIOR, Texto, longitud_:=10),
                ...
                Case SeccionesAcuseValor.SAcuseValor5
                    ...
                    Return New List(Of Nodo) From {
                                            Item(CamposAcuseValor.CP_ID_CLIENTE_SELLO, IdObject),
                                            Item(CamposAcuseValor.CP_ID_AGENTE_SELLO, IdObject),
                                            Item(CamposAcuseValor.CP_TIPO_SELLO, Entero),
                                            ...
                                            Item(SeccionesAcuseValor.SAcuseValor6, False)
                    }

                Case SeccionesAcuseValor.SAcuseValor6

                    Return New List(Of Nodo) From {
                                            Item(CamposAcuseValor.CA_RFC_CONSULTA_ACUSEVALOR, Texto, longitud_:=15),
                                            Item(CamposAcuseValor.CP_EMAIL_CONSULTA_ACUSEVALOR, Texto, longitud_:=50),
                                            Item(CamposAcuseValor.CP_RAZON_SOCIAL_CONSULTA_ACUSEVALOR, Texto, longitud_:=255)
                    }
