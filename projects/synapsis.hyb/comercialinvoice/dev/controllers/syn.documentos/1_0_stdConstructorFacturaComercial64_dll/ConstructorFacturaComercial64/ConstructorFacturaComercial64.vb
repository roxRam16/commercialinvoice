...
#Region "Methods"
        ...
        '            .idcampo = CamposClientes.CP_OBJECTID_CLIENTE
        '            }
        '        }
            ...
            Select Case idSeccion_
                ...
                Case SeccionesFacturaComercial.SFAC1
                    Return New List(Of Nodo) From {
                                            Item(CamposFacturaComercial.CP_TIPO_OPERACION, Entero, useAsMetadata_:=True),
                                            ...
                                            Item(CamposClientes.CP_OBJECTID_CLIENTE, IdObject), 'Agregarlo en el cliente
                                            Item(CamposClientes.CA_RAZON_SOCIAL, Texto, longitud_:=120),
                                            Item(CamposClientes.CP_CVE_CLIENTE, Texto), 'Agregarlo en el cliente
                                            Item(CamposClientes.CA_TAX_ID, Texto, longitud_:=11),
                                            Item(CamposClientes.CA_RFC_CLIENTE, Texto, longitud_:=13),
                                            Item(CamposClientes.CA_CURP_CLIENTE, Texto, longitud_:=20),
                                            ...
                                            Item(CamposFacturaComercial.CA_PAIS_FACTURACION, Texto, longitud_:=150),
                                            ...
                                            Item(CamposFacturaComercial.CP_BULTOS, Real),
                                            ...
                                            Item(CamposFacturaComercial.CP_APLICA_INCREMENTABLES, Booleano),
                                            Item(CamposAcuseValor.CP_ID_ACUSEVALOR, IdObject),
                                            Item(CamposFacturaComercial.CP_MARCADO_PEDIMENTO, Booleano),
                                            Item(CamposFacturaComercial.CP_ID_PEDIMENTO_ASOCIADO, IdObject),
                                            Item(CamposFacturaComercial.CP_ID_FACTURA_ORIGINAL, IdObject),
                                            Item(CamposFacturaComercial.CP_NUMERO_FACTURA_SUBDIVISION, Texto)
                                          }
                    ' Datos del proveedor
                Case SeccionesFacturaComercial.SFAC2
                    Return New List(Of Nodo) From {
                                             Item(CamposProveedorOperativo.CA_RAZON_SOCIAL_PROVEEDOR, Texto),
                                             Item(CamposProveedorOperativo.CP_ID_PROVEEDOR, Texto),
                                             ...
                                             Item(CamposProveedorOperativo.CA_CURP_PROVEEDOR, Texto, longitud_:=20),
                                             Item(CamposProveedorOperativo.CP_ID_DOMICILIO_PROVEEDOR, Texto),
                                             Item(CamposProveedorOperativo.CP_SEC_DOMICILIO_PROVEEDOR, Entero),
                                             Item(CamposProveedorOperativo.CA_DOMICILIO_FISCAL, Texto, longitud_:=450),
                                             Item(CamposDomicilio.CA_CALLE, Texto, longitud_:=80),
                                             Item(CamposDomicilio.CA_NUMERO_EXTERIOR, Texto, longitud_:=10),
                                             Item(CamposDomicilio.CA_NUMERO_INTERIOR, Texto, longitud_:=10),
                                             Item(CamposDomicilio.CA_NUMERO_EXT_INT, Texto, longitud_:=20),
                                             ...
                                             Item(CamposFacturaComercial.CA_APLICA_CERTIFICADO, Booleano),
                                             Item(CamposFacturaComercial.CP_NOMBRE_CERTIFICADOR, Texto, longitud_:=120),
                                             Item(CamposProveedorOperativo.CP_DESTINATARIO_PROVEEDOR, Booleano)
                    }
                ...
                Case SeccionesFacturaComercial.SFAC3
                    Return New List(Of Nodo) From {
                           ...
                           Item(CamposDestinatario.CP_ID_DOMICILIO_DESTINATARIO, IdObject),
                           Item(CamposDestinatario.CP_SEC_DOMICILIO_DESTINATARIO, Entero),
                           Item(CamposDestinatario.CA_DOMICILIO_FISCAL_DESTINATARIO, Texto, longitud_:=450),
                           Item(CamposDomicilio.CA_CALLE, Texto, longitud_:=80),
                           Item(CamposDomicilio.CA_NUMERO_EXTERIOR, Texto, longitud_:=10),
                           Item(CamposDomicilio.CA_NUMERO_INTERIOR, Texto, longitud_:=10),
                           Item(CamposDomicilio.CA_NUMERO_EXT_INT, Texto, longitud_:=10),
                           Item(CamposDomicilio.CA_CODIGO_POSTAL, Texto, longitud_:=10),
                           Item(CamposDomicilio.CA_COLONIA, Texto, longitud_:=80),
                           Item(CamposDomicilio.CA_LOCALIDAD, Texto, longitud_:=80),
                           Item(CamposDomicilio.CA_CIUDAD, Texto, longitud_:=80),
               ...
               ' Partidas
                Case SeccionesFacturaComercial.SFAC4
                    Return New List(Of Nodo) From {
                                             ...
                                             Item(CamposFacturaComercial.CP_APLICA_DESCRIPCION_ORIGINAL_MERCANCIA_PEDIMENTO, Booleano),
                                             ...
                                             Item(CamposFacturaComercial.CP_VALOR_AGREGADO_ITEM, Real, cantidadEnteros_:=18, cantidadDecimales_:=5),
                                             Item(CamposFacturaComercial.CP_MONEDA_VALOR_AGREGADO_ITEM, Texto),
                                             Item(CamposProducto.CP_TIMESTAMP, Texto),
                                             Item(CamposGlobales.CP_IDENTITY, Entero)
                    }
                ' Incrementables
                Case SeccionesFacturaComercial.SFAC5
                    Return New List(Of Nodo) From {
                                            Item(CamposFacturaComercial.CA_FLETES, Real),
                                            Item(CamposFacturaComercial.CA_MONEDA_FLETES, Texto),
                                            Item(CamposFacturaComercial.CA_SEGURO, Real),
                                            Item(CamposFacturaComercial.CA_MONEDA_SEGUROS, Texto),
                                            Item(CamposFacturaComercial.CA_EMBALAJES, Real),
                                            Item(CamposFacturaComercial.CA_MONEDA_EMBALAJES, Texto),
                                            Item(CamposFacturaComercial.CA_OTROS_INCREMENTABLES, Real),
                                            Item(CamposFacturaComercial.CA_MONEDA_OTROS_INCREMENTABLES, Texto),
                                            Item(CamposFacturaComercial.CA_DESCUENTOS, Real),
                                            Item(CamposFacturaComercial.CA_MONEDA_DESCUENTOS, Texto)
                    }
                Case Else
